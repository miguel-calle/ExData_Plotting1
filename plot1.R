...
#Show formatted histogram and save it to PNG
hist(elec_days[,Global_active_power],col = "red",xlab = "Global Active Power (kilowatts)",main="Global Active Power")
dev.print(png,filename="plot1.png",width = 480, height = 480, units = "px")
dev.off()
