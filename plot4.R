...
plot(elec_days[,Day_Time],elec_days[,Global_active_power],type="n",xlab = "",ylab="Global Active Power")
...
plot(elec_days[,Day_Time],elec_days[,Voltage],type="n",xlab="datetime",ylab="Voltage")
lines(elec_days[,Day_Time],elec_days[,Voltage])

plot(elec_days[,Day_Time],elec_days[,Global_reactive_power],type="n",xlab="datetime",ylab="Global_reactive_power")
lines(elec_days[,Day_Time],elec_days[,Global_reactive_power])


#Export the result to PNG
dev.print(png,filename="plot4.png",width = 480, height = 480, units = "px")
dev.off()